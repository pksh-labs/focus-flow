...
const FocusFlow = () => {
  ...
  return (
    <div className="w-[300px] p-4 font-sans bg-white">
      ...
      {/* Config Button */}
      <button className="w-full flex items-center justify-center gap-2 bg-indigo-600 text-white rounded-lg px-4 py-2 text-sm hover:bg-indigo-700"  onClick={openConfigPage}>
